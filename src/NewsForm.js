...
const NewsForm = () => {
    ...
    const [path, setPath] = useState("https://content-helper-f8fjehc2c4asgua8.canadacentral-01.azurewebsites.net");
    ...
    return (
        <Container>
            <h1 className="my-4" style={{ fontWeight: 'bold' }}>AI Shorts/Reels Video Content Generator</h1>
            <Row>
                <Col md={6}>
